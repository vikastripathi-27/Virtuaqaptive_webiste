    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>Our Services</h1>
            <span>The various services provided by us</span>
          </div>
        </div>
      </div>
    </div>
              ...
              <div class="row">
                <div class="col-md-6 align-self-center">
                  <div class="right-content">
                    ...
                    <h2>VIRTUAL <em>CAPTIVES</em></h2>
                    <p>
                      <h5>Start and manage your IT captives at the speed of cloud</h5>
                      <br>
                ...
                <div class="col-md-6">
                  <div class="left-image">
                    <img src="assets/images/captives.jpg" alt="" height="290px" style="margin-top: 135px">
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-md-7 align-self-center">
                  <div class="right-content">
                    ...
                    <h5>Providing <em>Professional services</em> at the speed of cloud</h5>
                    <br>
                    <p>
                ...
                <div class="col-md-5">
                  <div class="left-image">
                    <img src="assets/images/professional_service.jpg" alt="" height="300px" style="margin-top: 30px">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-12">
            <div class="more-info-content">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="left-image">
                    <img src="assets/images/outsourcing.jpg" alt="" height="410px" style="margin-top: 85px">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-12">
            <div class="more-info-content">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="left-image">
                    <img src="assets/images/bench.jpg" alt="" height="380px" style="margin-top: 130px">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-12">
            <div class="more-info-content">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="left-image">
                    <img src="assets/images/product.jpg" alt="" height="410px" style="margin-top: 90px">
                  </div>
                </div>
              </div>
            </div>
