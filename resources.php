              ...
              <div class="row">
                <div class="col-md-12 align-self-center">
                  <div class="right-content">
                                ...
                                <!-- blog 1 -->
                    <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo" style=" width: 100%; height: 55px;"><h5>Is AI the future?</h5></button>
                    <div id="demo" class="collapse">
                      <br>
                      <img src="assets/images/ai.jpg" class="img_blog">
                      <p>
                        <br>
                        <h5>What is AI?</h5>
                    ...
                    <!-- blog 2 -->
                    <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo2" style="width: 100%; height: 55px;"><h5>The new world of IOT</h5></button>
                    <div id="demo2" class="collapse">
                      <br>
                      <img src="assets/images/iot.jpg" class="img_blog">
                      <p>
                        <br>
                        ...
                        <br>
                        <b>2. Local and Personal Area Networks (LAN/PAN)</b>
                        <br>
                        ...
                        <br>
                        <b>3. Low Power Wide Area Networks (LPWAN)</b>
                        <br>
                    ...
                    <!-- blog 3 -->
                    <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo3" style="width: 100%; height: 55px;"><h5>Future of Web Developement</h5></button>
                    <div id="demo3" class="collapse">
                      <br>
                      <img src="assets/images/web.jpg"  class="img_blog">
                      <p>
                        <br>
                    ...
                    <!-- blog 4 -->
                    <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo4" style="width: 100%; height: 55px;"><h5>Career after COVID-19</h5></button>
                    <div id="demo4" class="collapse">
                      <br>
                      <img src="assets/images/covid.jpg"  class="img_blog">
                      <p>
                        <br>
