...
<html lang="en">
  ...
  <head>
    ...
    <meta name="description" content="Virtuaqaptive Consulting Services">
    ...
    <title>Virtuaqaptive Consulting Services</title>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <h2><em>Our Specialization</em></h2>
              <!-- <span>Aliquam id urna imperdiet libero mollis hendrerit</span> -->
            </div>
          </div>
          <div class="col-md-6">
            <div class="service-item">
              <img src="assets/images/service_01.jpg" alt="" height="370px">
          ...
          <div class="col-md-6">
            <div class="service-item">
              <img src="assets/images/service_02.jpg" alt="" height="370px">
              <div class="down-content">
                <h4>Skill India</h4>
                <p>A social initiative by <b>VQ</b> to inculcate technical skills in people desiring of pursuing their career in the field of technology. A technical journey which will make people industry ready</p>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="left-content">
              ...
              <h2 style="text-align: center;">Our solutions for your <em>business growth</em></h2>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="count-area-content">
                  ...
                  <div class="count-title">Branch</div>
                </div>
              </div>
            </div>
          </div>
   ...
   <!--  <footer>
    ...
    <div class="sub-footer">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <p>Copyright &copy; 2020 Virtuacaptive Consulting Services</p>
          </div>
        </div>
      </div>
    </div>
